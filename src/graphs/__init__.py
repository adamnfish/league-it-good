...
CHART_BLURBS: Dict[str, str] = {
    ...
    "transfer_costs":    "Points deducted from extra transfers (–4pts per transfer)",
    ...
    "consistency":       "Average weekly score with worst-to-best gameweek range",
    "chip_bench_boost":  "Total points from Bench Boost chips",
    "chip_triple_captain":"Total points from Triple Captain chips",
    "chip_free_hit":     "Total points from Free Hit chips",
    "chip_wildcard":     "Total points from Wildcard chips",
    "weekly_scores":     "Each manager's raw points, gameweek by gameweek",
    "league_position":   "League rank at the end of each gameweek",
